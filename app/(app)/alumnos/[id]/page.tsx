                ...
                {estadoCounts.map(({ estado, count }, idx) => {
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        'flex min-w-0 animate-in flex-col gap-0.5 rounded-lg border p-2 fade-in slide-in-from-bottom-2 fill-mode-backwards duration-500 transition-opacity hover:opacity-80 sm:gap-1 sm:p-4',
                        style.bg,
                        style.border,
                      )}
                      style={{ animationDelay: `${idx * 40}ms` }}
                    >
                      <span className={cn('text-[11px] font-medium leading-tight sm:text-sm', style.text)}>
                        {style.label}
                      </span>
                      <span className="font-heading text-xl font-bold text-foreground sm:text-3xl">
